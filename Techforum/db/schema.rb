...
ActiveRecord::Schema.define(version: 20140611065125) do
  ...
  add_index "replies", ["emp_login_id"], name: "index_replies_on_emp_login_id", using: :btree
  add_index "replies", ["forum_id"], name: "index_replies_on_forum_id", using: :btree
